...
public class ClerkOAuthWebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
        ...
        ClerkOAuthException exception = new ClerkOAuthException(message, e);
